public class Enemy
{
  ...
  public void drawEnemy(Player p)
  {
    ...
    if (health > 0 && ((type ==0)||(type==1)) && enemy != null)
      decideAction(p);
    else if (health > 0 && (type == 2) && enemy != null)
  ...
  private void drawPlayerKnocked()
  {
   ...
   else if (type == 2)  //Enemy 3
    {
      if (isHitLeft && filename != "Enemy3_Knocked.png" )
      {
        currentFrame = 0;
        left = true;
        filename = "Enemy3_Knocked.png";
        enemy = loadImage(filename);
        dim = 4;
        w = enemy.width/dim;
        h = enemy.height;
      } 
      else if (!isHitLeft && filename != "Enemy3_Knocked_right.png")
      {
        currentFrame = 0;
        left = false;
        filename = "Enemy3_Knocked_right.png";
        enemy = loadImage(filename);
        dim = 4;
        w = enemy.width/dim;
        h = enemy.height;
      }
      else if (filename == "Enemy3_Knocked.png")
      {
        if (currentFrame == 0 || currentFrame == 1)  //Move player back when hit during 0 and 1st frames
        {
          x+=24;
      ...
      else if (filename == "Enemy3_Knocked_right.png")
      {
        if (currentFrame == 0 || currentFrame == 1)  //Move player back when hit during 0 and 1st frames
        {
          x-=24;
        ...
        if ( (millis() - startTime)/1000 >= .20 *(currentFrame + 1))
        {
           if (currentFrame + 1 >= dim )
          {
            if (health > 0)
            {
              ...
              filename = "Enemy3_standing_Right.png";
              enemy = loadImage(filename);
              dim =1;
              w = enemy.width/dim;
              h = enemy.height;
 ...
 private void decideActionBoss(Player p)
  {
    float playerX = p.currentPlayerPositionX();
    float playerY = p.currentPlayerPositionY();
    int playerYValue = p.getY();
    ...
    if (timeInterval == -1 && !isHit)
    {
      ...
      if (rand <25) //25% chance (Attacking)
      {
        ...
        else
        {
          ...
          if (rand < 45)  //45% for Chasing Player
          {
            mode = 0;
            timeInterval = random(0, 3);
          }
  ...
  private boolean checkFileMovementName()
  {
      ...
      else if (type == 1)  //Enemy #2
    {
      ...
      else if (type == 2)  //Enemy #2
    {
      if ((filename != "Enemy3_walking_Right.png" && right && !left) 
        || (filename != "Enemy3_walking.png" && left && !right)
        || (filename != "Enemy3_walking" && left && (up || down))
        || (filename != "Enemy3_walking_Right.png" && !left && (up || down)))
        return true;
      else
        return false;
    }
      ...
      {        
          ...
          if (type == 2)
          {
            if (getTimeBetweenAttack() > 1)
            {
              ...
              activeFrame = frameCount;
              lastAttackTime = millis(); //Timer for delay
              filename = "Enemy3_Punch_Right.png";  //Enemy 1
              dim = 2;
              enemy = loadImage(filename);
              w = enemy.width/dim;
              h = enemy.height;
            }
            else if (filename != "Enemy3_standing_Right.png")
            {
              filename = "Enemy3_standing_Right.png";  //Enemy 1
              enemy = loadImage(filename);
              dim = 1;
              w = enemy.width/dim;
              h = enemy.height;
       ...
       if (type == 0)
           ...
           else if (type == 2)
          {
            if (getTimeBetweenAttack() > 1)
            {
              ...
              activeFrame = frameCount;
              lastAttackTime = millis(); //Timer for delay
              filename = "Enemy3_Punch.png";  //Enemy 1
              dim = 2;
              enemy = loadImage(filename);
              w = enemy.width/dim;
              h = enemy.height;
            ...
            {
              filename = "Enemy3_standing.png";  //Enemy 1
              enemy = loadImage(filename);
              dim = 1;
              w = enemy.width/dim;
              h = enemy.height;
  ...
  private void drawEnemyMoving()
  {
    if (!left)
    {
      ...
      {  
        ...
        else if (type == 2 && filename != "Enemy3_walking.png")
        {
          filename = "Enemy3_walking.png";  //Enemy 3
          dim = 3;
          enemy = loadImage(filename);
          w = enemy.width/dim;
          h = enemy.height;
      ...
      else  //Walking Right
      {
        ...
        else if (type == 2 && filename != "Enemy3_walking_Right_20.png")
        {
          filename = "Enemy3_walking_Right_20.png";  //Enemy 2
          dim = 3;
          enemy = loadImage(filename);
          w = enemy.width/dim;
          h = enemy.height;
    ...
    else  //Walking Left
    {
      ...
      {
        filename = "Enemy3_walking.png";  //Enemy 2
        dim = 3;
        enemy = loadImage(filename);
        w = enemy.width/dim;
        h = enemy.height;
  ...
  { 
    ...
    if (lastLeft && !right)  //Standing and looking to the left
    {
      ...
      else if (type == 2 && filename != "Enemy3_standing.png")
      {
        filename = "Enemy3_standing.png";  //Enemy 2
        enemy = loadImage(filename);
        w = enemy.width/dim;
        h = enemy.height;
      }
    ...
    else  //Standing and looking to the right
    {
      ...
      else if (type == 2 && filename != "Enemy3_standing_Right.png")
      {
        filename = "Enemy3_standing_Right.png";  //Enemy 2
        enemy = loadImage(filename);
        w = enemy.width/dim;
        h = enemy.height;
      }
  ...
  private void drawEnemyHit()
  {
    ...
    {
      if (type == 0 && filename != "Enemy1_HitStun.png")
      {
      ...
      else if (type == 2 && filename != "Enemy3_HitStun.png")
      {
        filename = "Enemy3_HitStun.png";  //Enemy 2
        enemy = loadImage(filename);
        dim = 1;
        w = enemy.width/dim;
        h = enemy.height;
    ...
    else  //Looking right
    {
      ...
      else if (type == 2 && filename != "Enemy3_HitStun_right.png")  //Enemy 2 Stunned (facing right)
      {
        filename = "Enemy3_HitStun_right.png"; 
        enemy = loadImage(filename);
        dim = 1;
        w = enemy.width/dim;
        h = enemy.height;
